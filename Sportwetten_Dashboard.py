# wetten_dashboard.py
# ============================================================
# SPORTWETTEN-DASHBOARD – MIT TABS UND OPTIMIERTER LAYOUT
# ============================================================
...
def render_sidebar():
    ...
    **Tabs:**
    ...
    """)
    st.sidebar.markdown("---")
    st.sidebar.caption("📅 v2.4 – Tabs & optimiertes Layout")

# ---- Eingabebereich (global) ----
def input_section() -> Tuple[TeamExpectedGoals, FullOdds]:
    ...
    with col1:
        st.subheader("Erwartete Tore (λ)")
        lam_h = st.number_input("Heim", min_value=0.0, value=1.75, step=0.05, format="%.2f")
        lam_a = st.number_input("Auswärts", min_value=0.0, value=1.5, step=0.05, format="%.2f")
...
def tab_spread(calc: BettingCalculator):
    ...
    # Visualisierung der Sigma-Werte
    fig = go.Figure()
