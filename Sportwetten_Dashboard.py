# wetten_dashboard.py
# ============================================================
# SPORTWETTEN-DASHBOARD – MIT NETTO-GEWINN IM BALKENDIAGRAMM
# ============================================================
...
def render_sidebar():
    ...
    **Tabs:**
    ...
    """)
    st.sidebar.markdown("---")
    st.sidebar.caption("📅 v2.7 – Netto-Gewinn im Balkendiagramm")
...
# ---- NEUE TAB-FUNKTION MIT NETTO-GEWINN ----
def tab_best_bets(calc: BettingCalculator):
    ...
    scenarios = [
        ...
        {"Fall": "Nur Ergebnis 1", "Gewinn": gain1, "Verlust": -loss2},  # = stake2
        {"Fall": "Nur Ergebnis 2", "Gewinn": gain2, "Verlust": -loss1},  # = stake1
        {"Fall": "Kein Ergebnis", "Gewinn": 0.0, "Verlust": -(stake1 + stake2)}
    ]

    # Tabelle mit Gewinn/Verlust (wie Excel)
    ...
    # Zusätzlich: Netto-Gewinn pro Szenario (für das Diagramm)
